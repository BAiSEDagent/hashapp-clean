...
PAYMASTER\_URL=https://your-paymaster.xyz # optional, for gasless transactions
\`\`\`
...
\| \`cdpApiKeyId\` \| \`string\` \| No \| Falls back to \`CDP\_API\_KEY\_ID\` env var \|
\| \`cdpApiKeySecret\` \| \`string\` \| No \| Falls back to \`CDP\_API\_KEY\_SECRET\` env var \|
\| \`cdpWalletSecret\` \| \`string\` \| No \| Falls back to \`CDP\_WALLET\_SECRET\` env var \|
...
const result = await base.subscription.charge({
 ...
 paymasterUrl: process.env.PAYMASTER\_URL,
 testnet: false,
});
\`\`\`
...
// Execute via wallet\_sendCalls or eth\_sendTransaction
\`\`\`
