...
The connected wallet must support the \`dataSuffix\` capability via ERC-5792 \`wallet\_sendCalls\`. Setting \`optional: true\` means the transaction proceeds even if the wallet doesn't support it.
