...
See \[references/rpc.md\](references/rpc.md) — append \`DATA\_SUFFIX\` to transaction data for ethers.js or raw \`window.ethereum\`.
...
\# Raw window.ethereum
grep -rn "window\\.ethereum\\\|eth\_sendTransaction" src/
\`\`\`
